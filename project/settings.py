...
INSTALLED_APPS = [
    ...
    # sitemap
    # https://pypi.org/project/django-sitemap-generate/
    # To install the sitemap framework,you will need to activate both 
    # the sites and the sitemap applications in our project
